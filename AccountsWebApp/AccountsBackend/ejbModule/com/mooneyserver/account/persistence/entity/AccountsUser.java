...
@NamedQueries({
	@NamedQuery(name = "accounts.schema.AccountsUser.findAllActiveUsers", query = "SELECT u FROM AccountsUser u where u.active <> 0"),
...
public class AccountsUser implements Serializable {
	...
	public boolean getActive() {
		return active != (byte) 0;
	}
	
	public void setActive(boolean isActive) {
		active = isActive ? (byte) 1 : (byte) 0;
	}
